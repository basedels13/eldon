//var0.6 cpuのスキル、MPゲージ、セーブ・実績
//next:マスロ1つくらい
//これポンした分のシナジー右枠に反映されてませんわ（点数計算時には繁栄されてるのでヨシ？）
//ガイザーでどのパイが対象になったかアニメーション出したい願望
//ライン待ちでルリエルドローした場合にルリエルを切る？
//捨てパイに同じキャララインがいるかお知らせ？
...
PlayertoCpu(9);}
  ...
  function corsor(){
    if(gamestate==10){
      ...
      cx2.fillText("※クリック後、ダイアログでOKを選択するとファイルをダウンロードします。", 80, 570);
          }}
