//var0.7 マスロ、バフアイコン追加、シナジー一覧ボタン追加
//next:マスロ　シナジーバフ持ち込み、シナジーバフ効果の実装
//相手がライン待ちでルリエルドローした場合にルリエルを切る？
...
function draw(){
  ...
  var canvas7 = document.getElementById("canvas7");//stageアニメーション用
...
//バフ 1スキン 2マナシールド 3ネイチャ 4ナソコア 5火傷 6凍結
//マスロ用　101-107 クレスト 
...
var raidscore=new Array(0,0,0);//0戦闘終了判定、1こちらの戦闘力、2相手の戦闘力
var raidSin=[];//バトル中にそろえたシナジー
var raidBuff=[];
var colorcode=new Array("#ffd659","#ff9359","#93ff59","#ff6459","#59bfff","#596fff","#a459ff")
var LPlist=new Array("一般","ヘル","ミリオネア","∞");//LP[0] 6~はレイド
...
for(var i=chrimg_src.length; i<10;i++){
  chrimg_src.push("Don_chara0.png")
};
var chrimgM_src= new Array("Don_gaia.png");
chrimg_src=chrimg_src.concat(chrimgM_src);
//console.log(chrimg_src);
...
//説明用
var epic_src =new Array("elstudio_bg1.png","Don_epic1.png","Don_epic2.png","Don_epic3.png","Don_epicline.png","Don_ss11.png","Don_ss12.png");
//裏＆ツモロンボタン
...
//これnumいらなくね（今更）
const SinagyB=[
  {num:101,value:1,id:"クレストオブガイア",text:"デニフに与えるダメージ増加"},
  {num:102,value:1,id:"クレストオブロッソ",text:"ベントスに与えるダメージ増加"},
  {num:103,value:1,id:"クレストオブベントス",text:"ガイアに与えるダメージ増加"},
  {num:104,value:1,id:"クレストオブデニフ",text:"ロッソに与えるダメージ増加"},
  {num:105,value:1,id:"クレストオブアドリアン",text:"神の使者に与えるダメージ増加"},
  {num:106,value:1,id:"クレストオブソーレス",text:"ヘルバオンに与えるダメージ増加"},
  {num:107,value:1,id:"クレストオブハルニエ",text:"ソーレスに与えるダメージ増加"},
  {num:108,value:1,id:"鋭さLv.1",text:"攻撃/受けるダメージ3%増加"},
  {num:108,value:2,id:"鋭さLv.2",text:"攻撃/受けるダメージ4%増加"},
  {num:108,value:3,id:"鋭さLv.3",text:"攻撃/受けるダメージ6%増加"},
  {num:109,value:1,id:"ナソード研究Lv.1",text:"ポンによる食い下がりを1減らす"},
  {num:109,value:2,id:"ナソード研究Lv.2",text:"ポンしても食い下がらなくなる"},
  {num:110,value:1,id:"精霊の加護Lv.1",text:"最大HPが40000増加する"},
  {num:110,value:2,id:"精霊の加護Lv.2",text:"最大HPが80000増加する"},
  {num:111,value:1,id:"物理特化Lv.1",text:"物理攻撃力レベル+2"},
  {num:111,value:2,id:"物理特化Lv.2",text:"物理攻撃力レベル+4"},
  {num:112,value:1,id:"魔法特化Lv.1",text:"魔法攻撃力レベル+2"},
  {num:112,value:2,id:"魔法特化Lv.2",text:"魔法攻撃力レベル+4"},
  {num:113,value:1,id:"貫徹する足取り",text:"1局に1度、手札のパイを1ラインに転職させる事ができる"},
  {num:114,value:1,id:"豊かな足取り",text:"1局に1度、手札のパイを2ラインに転職させる事ができる"},
  {num:115,value:1,id:"上手な足取り",text:"1局に1度、手札のパイを3ラインに転職させる事ができる"},
  {num:116,value:1,id:"敏捷さLv.1",text:"和了した時、10符ボーナスを得る"},
  {num:116,value:2,id:"敏捷さLv.2",text:"和了した時、30符ボーナスを得る"},
  {num:119,value:1,id:"殴り合いLv.1",text:"ロンアガリした場合、得点が1.2倍になる"},
  {num:119,value:2,id:"殴り合いLv.2",text:"ツモ得点が0.7倍になるがロン得点が1.5倍になる"},
  {num:120,value:2,id:"魔族",text:"1局に1度だけ、和了時に1翻ボーナスを得る"},
  {num:121,value:1,id:"巨人審判者Lv.1",text:"ツモアガリした場合、得点が1.2倍になる"},
  {num:121,value:1,id:"巨人審判者Lv.2",text:"ロン得点が0.7倍になるがツモ得点が1.5倍になる"},
  {num:122,value:1,id:"マナ守護",text:"MPを1ゲージ消費してマナブレイクできる"},
  {num:124,value:2,id:"原初的な動き",text:"空中攻撃が可能になる"},
  {num:126,value:1,id:"属性鍛錬者",text:"初手でパートナーと同じ属性のパイが入りやすくなる"},
  {num:127,value:1,id:"1ライン",text:"デバフに対して免疫を得る"},
  {num:128,value:1,id:"2ライン",text:"ツモ時にHPを10%回復する"},
  {num:129,value:1,id:"3ライン",text:"1度だけ受けるダメージを0にする（発動後3局の間再発動しない）"},
  {num:130,value:1,id:"痛いから問題ない",text:"HPが0になった時、一度だけHP1でとりあえず食いしばる"},
  {num:123,value:1,id:"探求する者",text:"対局終了時、ランダムでシナジーバフを1つ追加する"},
  {num:125,value:1,id:"渇望Lv.1",text:"対局開始時、ドラが1つ増える"},
  {num:125,value:2,id:"渇望Lv.2",text:"対局開始時、ドラが2つ増える"},
  {num:125,value:3,id:"渇望Lv.3",text:"対局開始時ドラが3つ増え、さらに手札に必ずドラが1枚以上入る"},
  {num:117,value:1,id:"正義を貫徹する者",text:"リーチしている間、自分が捨てたパイはロンされない"},
  {num:133,value:1,id:"戦場の天使",text:"空中攻撃ダメージ増加"},
  {num:132,value:1,id:"ラビィの友達",text:"1局に1度、手札のニーシャを他のパイに変える事ができる"},
  {num:131,value:1,id:"機械工学",text:"自分が和了した時、その手札を山札に戻す"},
    ];
var key13=0;
var key27=0;//esc
var key90=0;//z
...
if(gamestate ==0){//ほんぺ
  ...
  //ミリオネア
    ...
    if(raidscore[0]==0){
      ...
      if(turn==1){
      cx3.clearRect(95,499,705,110);
      cx2.clearRect(95,499,705,110);
      }
      turnchecker(1);
      //turnrole();
    }else if(raidscore[0]==1){
    if(LP[1] >0 && LP[2] >0){
      gamestate =1;
      raidscore[0]=0;
      deckHandler();
...
if(LP[1] >0 && LP[2]>0 && LP[3] >0 && LP[4]>0){
  ...
  console.log(pagestate)
    ...
    if(opLock==3){
      if(mouseX >40 && mouseY > 100 && mouseX <620 && mouseY <300){
      Yakucheck(90);
      return false;
      }
      if(mouseX >40 && mouseY > 300 && mouseX <620 && mouseY <480){
      Yakucheck(-90);
      return false;
      }
      yakumap.alpha=0;
    ...
    if(mouseX >0 && mouseX< 100){
      ...
      if(mouseY >200 && mouseY<300){
        if(LP[0]==6){Skillname(2,navisw);}else{Skillname(3,navisw);}
      }
      if(mouseY >300 && mouseY<400){
        if(LP[0]==16){Skillname(1,navisw);}else{Skillname(4,navisw);}
      }
  ...
  if(mouseY >100 && mouseY <200){SpecialSkill(1,2)
    ...
    if(LP[0]==6){SpecialSkill(1,2);}else{SpecialSkill(1,3);}
  }else if(mouseY >300 && mouseY <400){
    if(LP[0]==16){SpecialSkill(1,1);}else{SpecialSkill(1,4)}
  ...
  if(mouseY >400 && mouseY <440 && mouseX >630 && mouseX <710){
    ...
    function Menu(){
      ...
      if(winrank[3]>=5){
        ...
        cx2.fillStyle = "black";
        cx2.font = "bold 28px 'Century Gothic'";
        cx2.fillText(" 【フリーバトル】",430,60)
        ...
        drawbuttom2(470,410,"START！")
              ...
              if(mouseY >260 && mouseY <310){//マスロ
                ...
                cx2.fillText("◀ "+chrlist[chara[1]],520,150);
                cx2.fillText(" ▶",670,150)
                cx2.fillText("みかた",390,185);
                cx2.fillText("◀ "+chrlist[chara[2]],520,185);
                cx2.fillText(" ▶",670,185)
                cx2.font = "24px 'Century Gothic'";
                cx2.fillText("フェイバリット",390,220)
                cx2.font = "bold 22px 'Century Gothic'";
                cx2.fillText(donpai[Mpai].sub,430,250);
                CMpai=new createjs.Bitmap(eltear_src[Mpai]);
                CMpai.x=505;
                CMpai.y=270;
                CMpai.scaleX=0.75;
                CMpai.scaleY=0.75;
                field.addChild(CMpai);
                //cx2.drawImage(canvas6,40+60*(Mpai%9),100+78*Math.floor(Mpai/9),60,78,505,270,90,117);
                drawbuttom(610,270,"変更");
                drawbuttom2(470,410,"START！")
              }}
          ...
          case 6:
            ...
            if(mouseX >510 && mouseX <560 && mouseY >130 && mouseY <160){
              ...
              if(mouseX >510 && mouseX <560 && mouseY >160 && mouseY <190){
                se3.play();
                if(chara[4]==0){chara[4]=chrlist.length-1}else{chara[4]-=1}
                cx2.font = "24px 'Century Gothic'";
                cx2.fillStyle = "black";
                cx2.clearRect(510,160,170,26)
                cx2.fillText("◀ "+chrlist[chara[4]],520,185);
                }
            if(mouseX >670 && mouseX <705 && mouseY >130 && mouseY <160){
              ...
              if(mouseX >670 && mouseX <705 && mouseY >160 && mouseY <190){
                se3.play();
                if(chara[4]==0){chara[4]=chrlist.length-1}else{chara[4]-=1}
                cx2.font = "24px 'Century Gothic'";
                cx2.fillStyle = "black";
              ...
              if(mouseX >610 && mouseX <690 && mouseY >270 && mouseY <310){
              opLock=1;
              se4.play();
              cx4.clearRect(10,100,610,400)
              cx4.fillStyle = "rgba(20,20,20,0.7)";
              cx4.fillRect(10,100,610,390)
              cx4.drawImage(canvas6,0,0,800,600);
              cx4.clearRect(460,412,120,78);
              cx4.fillRect(460,412,120,78)
              }
            }else if(opLock==1){
              //mpai選択画面
              if(mouseX >40 && mouseX <580 && mouseY >100 && mouseY <490){
                if(mouseX >460 && mouseX <580 && mouseY >412 && mouseY <490){
                return false;
                }
                Mpai=Math.floor((mouseX-40)/60)+9*(Math.floor((mouseY-100)/78));
                console.log(Mpai);
                se3.play();
                cx2.clearRect(430,225,265,40);
                cx2.font = "bold 22px 'Century Gothic'";
                cx2.fillStyle = "black";
                cx2.fillText(donpai[Mpai].sub,430,250)
                field.removeChild(CMpai);
              ...
              switch(msgstate){
                case 0:
                  ...
                  if(mouseX >50 && mouseX <250 && mouseY >110 && mouseY <150){
                    ...
                    cx2.fillText("「アイシャ」「ラシェ」「エリシス」のように、", 90, 350);
                    cx2.fillText("同じキャラクターを3枚1組として、3組揃えます。", 90, 380);
                    cx2.fillText("ただし、同じキャラクターを6枚集めても、3ペアにはなりません。", 90, 420);
                    cx2.fillText("「ポン」によって効率的にペアを揃えることができます。", 90, 450);
                    cx2.drawImage(epic,0,0,600,128,90,95,600,128);
                    msgstate=2;
                    cx2.clearRect(80,530,670,70)
                    cx2.font = "18px Arial";
                    cx2.fillText("3ペアは最も基本的な役です。", 80, 550);
                    cx2.fillText("同じキャラ3枚を1組として、3組揃える必要があります。", 80, 570);
                  }}
                  if(mouseX >50 && mouseX <250 && mouseY >150 && mouseY <190){
                    ...
                    cx2.fillText("「1」「2」「3」のように、パイに書かれた数字が", 90, 350);
                    cx2.fillText("同じパイを9枚揃えることでライン通貫が成立します。", 90, 380);
                    cx2.fillText("同じパイが複数あっても構いません。", 90, 410);
                  ...
                  if(mouseX >50 && mouseX <250 && mouseY >190 && mouseY <230){
                    ...
                    cx2.fillText("「エピックライン」という各キャラごとに定められた", 90, 380);
                    cx2.fillText("パイのみを9枚集めることで成立します。", 90, 410);
                    cx2.fillText("この時、同じパイが複数含まれてはいけません。", 90, 440);
                    msgstate=2;
                    cx2.clearRect(80,530,670,70)
                    cx2.font = "18px Arial";
                  ...
                  if(mouseX >50 && mouseX <250 && mouseY >230 && mouseY <270){
                    ...
                    cx2.fillText("同じキャラが手元に2枚以上", 60, 205);
                    cx2.fillText("あれば、その捨てパイを貰う", 60, 230);
                    cx2.fillText("ことができるポン！", 60, 255);
                    cx2.fillText(" ポンした後は山からパイを", 60, 285);
                    cx2.fillText("引かずに、手札のパイを1枚", 60, 310);
                    cx2.fillText("選んで捨てるんだポン！", 60, 335);
                    cx2.fillText(" ポンすると「3ペア」を揃え", 60, 365);
                    cx2.fillText("やすくなるけど、その代わり", 60, 390);
                    cx2.fillText("得点が少し減っちゃうポン…", 60, 415);
                    cx2.fillText("注意するんだポン！ポポン！", 60, 440);
                    msgstate=2;
                    cx2.clearRect(80,530,670,70)
                    cx2.font = "18px Arial";
                ...
                case 3:
                  ...
                  if(mouseX >80 && mouseY > 100 && mouseX <640 && mouseY <300){
                    Yakucheck(90);
                    return false;
                    }
                    if(mouseX >80 && mouseY > 300 && mouseX <640 && mouseY <480){
                    Yakucheck(-90);
                    return false;
                    }
                case 2:
...
switch (musicset[2]){
  ...
  if(LP[0]==6){
    ...
    cx1.lineWidth = 3;
    cx1.strokeRect(160,65,450,20);
    var a=(Math.floor(LP[2]/10000))%7;
    var b=a+1;
    if(b>6){b=0};
    cx1.fillStyle=colorcode[a];
    cx1.fillRect(160,65,450,20);
    var c=450*(LP[2]-10000*(Math.floor(LP[2]/10000)))/10000;
    cx1.fillStyle=colorcode[b];
    cx1.fillRect(160,65,c,20);
    cx1.fillStyle="white";
    cx1.strokeText("×"+Math.floor(LP[2]/10000),560,81);
    cx1.fillText("×"+Math.floor(LP[2]/10000),560,81);
    parentY =300
    e11.src=chrimg_src[chara[4]]
    e11.onload=function(){
    cx1.drawImage(e11,500,0,300,300,0,parentY,100,100)
    parentY=400
    e14.src=chrimg_src[chara[1]]
    e14.onload=function(){
    cx1.drawImage(e14,500,0,300,300,0,parentY,100,100)
    parentY=100
    //敵の立ち絵
    e13.src=chrimg_src[chara[2]]
    e13.onload=function(){
    cx1.drawImage(e13,500,0,300,600,0,parentY,100,200)
    cx1.fillStyle ="white";
    ...
    riverx=new Array(0,120,120)
    rivery=new Array(0,300,100)
...
var F=Buff[i].filter(value=>value==6);
  ...
  function turnchecker(type=0){
    console.log('turnchecker',turn,type)
    //type 1 ->レイドでバトル続行時
    if(type==1){
          //飛んだ人を飛ばす
    //turn +=1;
    switch(turn){
      case 1:
        ...
        var Blaze=Buff[2].filter(value=>value==5)
        if(Blaze.length>0){
          var F=Buff[2].findIndex(value=>value==5)
          Buff[2].splice(F,1);
          Buffdraw(2);
          }
        if(Freeze.length>0 || LP[2]<=0){
          ...
          Blaze=Buff[3].filter(value=>value==5)
          if(Blaze.length>0){
            var F=Buff[3].findIndex(value=>value==5)
            Buff[3].splice(F,1)
            Buffdraw(3);
          }
          if(Freeze.length>0 || LP[3]<=0){
            ...
            Blaze=Buff[4].filter(value=>value==5)
            if(Blaze.length>0){
              var F=Buff[4].findIndex(value=>value==5)
              Buff[4].splice(F,1)
              Buffdraw(4);
              }
      ...
      case 2:
        ...
        var Blaze=Buff[3].filter(value=>value==5)
        if(Blaze.length>0){
          var F=Buff[3].findIndex(value=>value==5)
          Buff[3].splice(F,1)
          Buffdraw(3);
        ...
        if(Freeze.length>0 || LP[3]<=0){
          ...
          Blaze=Buff[1].filter(value=>value==5)
            if(Blaze.length>0){
              var F=Buff[1].findIndex(value=>value==5)
              Buff[1].splice(F,1)
              }
              Buffdraw(1);
      ...
      case 3:
        ...
        var Blaze=Buff[4].filter(value=>value==5)
          if(Blaze.length>0){
            var F=Buff[4].findIndex(value=>value==5)
            Buff[4].splice(F,1)
            }
        ...
        if(Freeze.length>0 || LP[4]<=0){
          ...
          if(Freeze.length>0 || LP[1]<=0){
            ...
            Blaze=Buff[2].filter(value=>value==5)
        if(Freeze.length>0 || LP[2]<=0){
          if(Freeze.length>0){
          var F=Buff[2].findIndex(value=>value==6)
          Buff[2].splice(F,1)
      ...
      case 4:
          ...
          var Blaze=Buff[1].filter(value=>value==5)
          if(Blaze.length>0){
            var F=Buff[1].findIndex(value=>value==5)
            Buff[1].splice(F,1)
          }
    ...
    cpu(4);
      ...
      if(LP[0]==16 && turn==1 && ponsw[0]==0 && Fr1==-1 && LP[1]>0){
        //マスロ
        if(Pon(1)){
        se1.play();
        cx2.clearRect(630,400,80,40)
...
function handgraph(num,player){
  console.log('handgraph',num,player,tumotemp)
    ...
    if(counter[player]==14 || counter[player]==28  || counter[player]==42){
    rivery[player] +=50
    riverx[player] =110
    }
    if(chara[player]==3){
...
PlayertoCpu(9);}
  ...
  //end 3->オールマイティ以外なら何でも　ポンしてないやつ
      if(end>0){
        console.log('end',end,reach[player])
        if(reach[player]==1){reach[player]=2};
        switch(end){
          case 2:
          case 3:
    ...
    switch(mode){
      ...
      default:
          switch(player){
            ...
            break;
            default:
              console.log('judge error',player)
            //自信ないから残しとく
            break;
          }
  ...
  function TumoRon(player,num,dub=1){
    ...
    if(ponsw[player] >0){
      han[player] -=2;
      var A=raidBuff.findIndex(value=>value=="ナソード研究Lv.2");
      if(A!==-1){han[player] +=2}else{
      var A=raidBuff.findIndex(value=>value=="ナソード研究Lv.1");
      if(A!==-1){han[player] +=1}
      }
    };//鳴き
  ...
  if(LP[0]!==6){
    ...
    if(LP[0]==6){
      ...
      if(player ==1){
        ...
        reach[1]=0;
        ippatu[1]=0;
        var A=raidBuff.findIndex(value =>value=="機械工学");
        if(A !==-1){
          var B=vichand.filter(value=>value>=0);
          //console.log(vichand);
          deck=deck.concat(B);
          shuffle();
        }
        hand1b=deck.splice(0,8)
        hand1=hand1b.concat()
        hand1.sort(compareFunc);
        hand1.unshift(-1)
        hand1.push(100)
  ...
  function Score(player){
    ...
    var A=raidBuff.findIndex(value=>value=="敏捷さLv.2");
    if(A!==-1){
      fu+=30;
    }else{
    var A=raidBuff.findIndex(value=>value=="敏捷さLv.1");
    if(A!==-1){
      fu+=10;
    }
    }
  ...
  function Nodyaku2(player,mode=-1){//役
    //該当するシナジーの組み合わせ（同キャラは重複しない）を判定
      ...
      if(nodpair2.length >=2){
        ...
        resultA[0]+=B
        for(var i=0;i<nodpair2.length;i++){raidSin.push(130);}
      ...
      if(nodpair2.length >=2){
        var B=1+Math.floor((nodpair2.length-1)/2)
        resultA[0]+=B
        for(var i=0;i<nodpair2.length;i++){raidSin.push(126);}
      ...
      if(nodpair2.length >=2){
        var B=1+Math.floor((nodpair2.length-1)/2)
        resultA[0]+=B
        for(var i=0;i<nodpair2.length;i++){raidSin.push(125);}
      ...
      if(nodpair2.length >=2){
        ...
        if(nodpair2.length >=2){
          var B=1+Math.floor((nodpair2.length-1)/2)
          resultA[0]+=B
          for(var i=0;i<nodpair2.length;i++){raidSin.push(110);}
          ...
          if(nodpair2.length >=2){
            var B=1+Math.floor((nodpair2.length-1)/2)
            resultA[0]+=B
            for(var i=0;i<nodpair2.length;i++){raidSin.push(109);}
      ...
      if(nodpair2.length >=2){
        var B=1+Math.floor((nodpair2.length-1)/2)
        resultA[0]+=B
        for(var i=0;i<nodpair2.length;i++){raidSin.push(119);}
      ...
      if(nodpair2.length >=2){
        var B=1+Math.floor((nodpair2.length-1)/2)
        resultA[0]+=B
        for(var i=0;i<nodpair2.length;i++){raidSin.push(118);}
      ...
      if(nodpair2.length >=2){
        var B=1+Math.floor((nodpair2.length-1)/2)
        resultA[0]+=B
        for(var i=0;i<nodpair2.length;i++){raidSin.push(117);}
      ...
      if(nodpair2.length >=2){
        var B=1+Math.floor((nodpair2.length-1)/2)
        resultA[0]+=B
        for(var i=0;i<nodpair2.length;i++){raidSin.push(116);}
      ...
      if(nodpair2.length >=2){
        var B=1+Math.floor((nodpair2.length-1)/2)
        resultA[0]+=B
        for(var i=0;i<nodpair2.length;i++){raidSin.push(112);}
      ...
      if(nodpair2.length >=2){
        var B=1+Math.floor((nodpair2.length-1)/2)
        resultA[0]+=B
        for(var i=0;i<nodpair2.length;i++){raidSin.push(111);}
        ...
        if(nodpair2.length >=2){
          var B=1+Math.floor((nodpair2.length-1)/2)
          resultA[0]+=B
          for(var i=0;i<nodpair2.length;i++){raidSin.push(108);}
  ...
  function Pon(player,num=-1){//自分の同じキャラ2枚+前の人が切った同じキャラを除外
    if(num==-1){
      ...
      var result=0;
      var B=Buff[player].findIndex(value=>value==5);
      if(reach[player]==3 || B !==-1){
        //立直or火傷しているならポンできない
        //console.log('ron false');
        return false;
      }
    ...
    for(var i=1;i<5;i++){
      if(ippatu[i]==1){
        ...
        e15.onload=function(){
          se8.play();
          window.requestAnimationFrame((ts)=>PonAnimation(ts,0,player,chara[player]))
      }
        break;
      case 2:
        cx1.fillStyle = "rgba(20,20,20,0.5)";
  ...
  function BattlePhase(){
    ...
    cx2.fillStyle = "white";
    cx2.font = "26px 'Century Gothic'";
    cx2.fillText("シナジー選択",300,130);
    cx2.font = "22px 'Century Gothic'";
    cx2.fillText("以下の中からシナジーバフを1つ選んで獲得できます",110,155);
      //一覧表示
      raidSinlist=[];
      raidmapY=0;
  var rect = new createjs.Shape();
  rect.graphics
          ...
          .drawRect(40, 180, 340, 2000);
  raidmap.addChild(rect);
  var rect = new createjs.Shape();
  rect.graphics
          .beginFill("rgba(250,250,250,0.7)")
          .drawRect(420, 180, 340, 280);
  raidmapB.addChild(rect);
  var shapeMask = new createjs.Shape();
shapeMask.graphics
        .beginFill("gold")
        .drawRect(40, 180, 340, 280);
        for (var i=0;i<raidSin.length;i++){
          var A=raidSin.filter(value=>value==raidSin[i]);
          var a=SinagyB.filter(value=>value.num==raidSin[i]);
          if(!a){console.log(raidSin[i],'sinagyB error!');}
          var b=a.findIndex(value=>value.value==A.length);
          if(b==-1){b=0};
          var c=raidSinlist.findIndex(value=>value==a[b].id)
          if(c==-1){raidSinlist.push(a[b].id)};
        }
        raidmap.mask = shapeMask;
        if(raidSinlist.length>5){
          cx2.font = "22px 'Century Gothic'";
          cx2.fillText("▲",180,180);
          cx2.fillText("▼",180,480)
        }
        //cx2.fillText("▷",320,360)
        drawbuttom(680,460,"進む");
        //console.log(raidSinlist);
        var X=50;
        var Y=190;
        for(var i=0; i<raidSinlist.length; i++){
          var shape = new createjs.Shape();
        shape.graphics.beginStroke("black");
        shape.graphics.drawRoundRect(0, 0, 330, 40, 10, 10); 
        shape.x=X-5;
        shape.y=Y-5;
        raidmap.addChild(shape); // 表示リストに追加
        var T=SinagyB.findIndex(value=>value.id==raidSinlist[i]);
        var t= new createjs.Text(SinagyB[T].id, "bold 16px Arial", "black");
        var s= new createjs.Text(SinagyB[T].text, "bold 12px Arial", "black");
        t.x=X;
        t.y=Y;
        s.x=X;
        s.y=Y+15;
        ...
        X=430;
        Y=190;
        for(var i=0; i<raidBuff.length; i++){
          var shape = new createjs.Shape();
        shape.graphics.beginStroke("black");
        shape.graphics.drawRoundRect(0, 0, 330, 40, 10, 10); 
        shape.x=X-5;
        shape.y=Y-5;
        raidmapB.addChild(shape); // 表示リストに追加
        var T=SinagyB.findIndex(value=>value.id==raidBuff[i]);
        var t= new createjs.Text(SinagyB[T].id, "bold 16px Arial", "black");
        var s= new createjs.Text(SinagyB[T].text, "bold 12px Arial", "black");
        t.x=X;
        t.y=Y;
      ...
      case 3:
        if(mouseX >175 && mouseX <210){
          if(mouseY >150 && mouseY < 180){
            ...
            if(raidmapY>0){raidmapY=0};
            createjs.Tween.get(raidmap, {override: true})
            .to({y: raidmapY}, 200, createjs.Ease.cubicInOut);
          }}
        if(mouseX >175 && mouseX <210){
          if(mouseY >460 && mouseY < 490){
            if(raidmapY>-45*(raidSinlist.length-5)){
              raidmapY-=45;
              }
              createjs.Tween.get(raidmap, {override: true})
              .to({y: raidmapY}, 200, createjs.Ease.cubicInOut);
          }}
          if(mouseX >40 && mouseX <380){
            if(mouseY >185 && mouseY < 455){
              //バフ選択をよぉ270
              var state=Math.floor((mouseY-185)/45)-raidmapY/45;
              if(state<raidSinlist.length){
                if(raidSinlist[state]==stateA){
                  stateA=0;
                  cx4.clearRect(40,185,340,270);
                }else{
                  stateA=raidSinlist[state];
                var x=45;
                var y=185+45*Math.floor((mouseY-185)/45)
              cx4.clearRect(40,185,340,270);
              se4.play();
              cx4.lineWidth = 2;
              cx4.strokeStyle="orange";
              createRoundRect(x, y, 330, 40, 10,4);
              cx4.stroke();
              console.log(raidSinlist[state])
                }
            }
            }}
        if(mouseX >680 && mouseX <760){
          if(mouseY >460 && mouseY < 500){
            if(stateA==0){
              ...
              cx4.strokeStyle ="rgba(250,250,250,0.9)";
              cx4.lineWidth=5;
              cx4.strokeText("シナジーバフが選択されていませんが進みますか？",120,200);
              cx4.fillText("シナジーバフが選択されていませんが進みますか？",120,200);
              cx4.fillStyle="#ff3838";
              cx4.strokeRect(220,240,120,60)
              cx4.fillRect(220,240,120,60)
              cx4.fillStyle = "#f0f0f0";
              ...
              raidmap.removeAllChildren();
              raidmapB.removeAllChildren();
              cx4.clearRect(0,0,800,600);
              raidBuff.push(stateA);
              console.log(raidBuff);
              cx2.fillStyle = "white";
              cx2.font = "26px 'Century Gothic'";
              cx2.fillText("与えたダメージ "+raidscore[1],190,300);
              cx2.fillText("受けたダメージ "+raidscore[2],190,330);
              cx2.font = "20px 'Century Gothic'";
              cx2.fillText("Get Ready for the next battle! ",290,430);
              LP[2]-=raidscore[1];
              LP[1]-=raidscore[2];
              raidscore[0]=1;
              raidSin=[];
  ...
  function corsor(){
    ...
    cx3.strokeStyle ='yellow'
    cx3.lineWidth = 2;
    if(mouseX >690 && mouseX <690+size && mouseY >500 && mouseY < 600){
      cx3.clearRect(95,490,700,100)
      cx3.strokeRect(690,500,size,sizey)
      }
    }
...
//ポンボタン
  ...
  function Elname(num,numb=0){
    ...
    function createRoundRect(x, y, width, height, radius,cx=2){
      switch(cx){
        case 2:
          cx2.beginPath();
          cx2.moveTo(x + radius, y);
          cx2.lineTo(x + width - radius, y);
          cx2.arcTo(x + width, y, x + width, y + radius, radius);
          cx2.lineTo(x + width, y + height - radius);
          cx2.arcTo(x + width, y + height, x + width - radius , y + height, radius);
          cx2.lineTo(x + radius, y + height); 
          cx2.arcTo(x, y + height, x, y + height - radius, radius);
          cx2.lineTo(x, y + radius);
          cx2.arcTo(x, y, x + radius, y, radius);
          cx2.closePath();
          break;
        case 4:
          cx4.beginPath();
          cx4.moveTo(x + radius, y);
          cx4.lineTo(x + width - radius, y);
          cx4.arcTo(x + width, y, x + width, y + radius, radius);
          cx4.lineTo(x + width, y + height - radius);
          cx4.arcTo(x + width, y + height, x + width - radius , y + height, radius);
          cx4.lineTo(x + radius, y + height); 
          cx4.arcTo(x, y + height, x, y + height - radius, radius);
          cx4.lineTo(x, y + radius);
          cx4.arcTo(x, y, x + radius, y, radius);
          cx4.closePath();
          break;
      }
    }             
...
function PonAnimation(ts,A=0,B,C=0){
  //C->どのキャラか
    cx4.globalAlpha = alpha;
    A+=1;
    loopX+=3
    ...
    cx4.drawImage(e15,400,200-xx+Yad,300,xx*2,loopX2,250-xx,300,xx*2)
    cx4.strokeStyle = "white";
    cx4.lineWidth = 6;
    cx4.beginPath();
    cx4.moveTo(0,250-xx);
    ...
    cx4.rotate(15*Math.PI/180);
    if(alpha>0){
    if(A<30){window.requestAnimationFrame((ts)=>PonAnimation(ts,A,B,C));}else{
    alpha -=0.1
    window.requestAnimationFrame((ts)=>PonAnimation(ts,A,B,C));}
    }else if(alpha <=0){
    cx4.clearRect(0,0,800,600);cx4.globalAlpha = 1;
    console.log(B)
    switch(B){
...
function CSkillAnimation(pc,target,skill,a=0,b=0){
  //createjs使ったアニメーションの実験　ガイザーのパイを記述する
  //pc->発動者　target->対象　skill->スキル種別 a b->予備変数
  console.log('CskillAnimation',pc,target,skill,a,b);
  function endanimation(){
    cx4.clearRect(0,Y,200,100)
    field.removeChild(rect);
    field.removeChild(A);
    field.removeChild(B);
    cx4.clearRect(0,0,800,600)
            console.log('LifeDmg ended');
    if(pc!==1){
      ctl[pc]=4
      cpuplay(pc);
    };
  ...
  switch(skill){
    case 1:
      ...
      switch(target){
        ...
        var A= new createjs.Bitmap(eltear_src[a]);
        var B= new createjs.Bitmap(eltear_src[b]);
        var rect = new createjs.Shape;
        rect.graphics.beginFill("rgba(0,0,0,0.5)");
        rect.graphics.drawRect(150,Y,400,100)
        rect.alpha=0;
        field.addChild(rect);
        ...
        function Ar2(){
          ...
          field.addChild(A);
          field.addChild(B);
          window.requestAnimationFrame((ts)=>Ar(ts,0));
        };
        function Ar(ts=0,s=0){
          //待ち
          s+=1;
          var sX=s**2;
          if(sX>100){sX=100}
        if(s<60){
          cx4.fillStyle='#38a9ff';
          cx4.beginPath();
          cx4.arrow(280,Y+45,280+sX,Y+45,[0,5,-20,5,-20,15]);
          cx4.fill();
        window.requestAnimationFrame((ts)=>Ar(ts,s));
        }else{
        cx4.clearRect(270,Y,120,100);
        createjs.Tween.get(A)
        .to({rotation: 5, alpha: 0.5},200,createjs.Ease.cubicOut);
        createjs.Tween.get(B)
        .to({x:50, alpha: 0.5},600,createjs.Ease.cubicOut)
        .call(endanimation);
        }
        }
       break;
       case 2:
        //メモライズ
        console.log('Cskill ended');
        if(pc!==1){
          ctl[pc]=4
          cpuplay(pc);
        };
        if(pc==1 && b==-1){PlayertoCpu(target)};
        break;
       default:
        console.log('Cskill ended');
        if(pc!==1){
...
function SpecialSkill(player,target=0){
  ...
  switch(target){
    case 1:
      ...
      if(T1.length>=1){
        ...
        DP[1]-=20;
        drawDP(1);
        Cskillprepare[0]=player;
        Cskillprepare[1]=target;
        if(Skin ==-1){
    A=1+Math.floor(Math.random()*(hand1.length-2));
    B=Math.floor(Math.random()*(T1.length));
    B=trash1.findIndex(value=>value==T1[B]);
    E=hand1.splice(A,1);
    Extrash.push(E[0]);
    hand1.push(trash1[B]);
    Cskillprepare[2]=1;
    Cskillprepare[3]=E[0];
    Cskillprepare[4]=trash1[B];
    trash1[B]=-1;
    Buff[target].push(5,5,5)
    Buffdraw(target);
    judge(1);
    console.log(Cskillprepare);
        }else{
          //スキン
          Cskillprepare[2]=-1;
        }
  ...
  break;
    case 2:
      ...
      if(T1.length>=1){
        ...
        if(Skin ==-1){
          ...
          B=Math.floor(Math.random()*(T1.length));
          B=trash2.findIndex(value=>value==T1[B]);
          E=hand2.splice(A,1);
          Extrash.push(E[0]);
          hand2.push(trash2[B]);
          Cskillprepare[2]=1;
          Cskillprepare[3]=E[0];
          Cskillprepare[4]=trash2[B];
          trash2[B]=-1;
          Buff[target].push(5,5,5)
          Buffdraw(target);
    hand2.sort(compareFunc);
    ...
    case 3:
      ...
      if(T1.length>=1){
        ...
        if(Skin ==-1){
          ...
          B=Math.floor(Math.random()*(T1.length));
          B=trash3.findIndex(value=>value==T1[B]);
          E=hand3.splice(A,1);
          Extrash.push(E[0]);
          hand3.push(trash3[B]);
          Cskillprepare[2]=1;
          Cskillprepare[3]=E[0];
          Cskillprepare[4]=trash3[B];
          trash3[B]=-1;
          Buff[target].push(5,5,5)
          Buffdraw(target);
    hand3.sort(compareFunc);
    ...
    case 4:
      ...
      if(T1.length>=1){
        ...
        if(Skin ==-1){
          ...
          B=Math.floor(Math.random()*(T1.length));
          B=trash4.findIndex(value=>value==T1[B]);
          E=hand4.splice(A,1);
          Extrash.push(E[0]);
          hand4.push(trash4[B]);
          Cskillprepare[2]=1;
          Cskillprepare[3]=E[0];
          Cskillprepare[4]=trash4[B];
          trash4[B]=-1;
          Buff[target].push(5,5,5)
          Buffdraw(target);
    hand4.sort(compareFunc);
    ...
    default:
      ...
      if(ponsw[1]!==1){
        ...
        //console.log(Cskillprepare);
        CSkillAnimation(Cskillprepare[0],Cskillprepare[1],Cskillprepare[2],Cskillprepare[3],Cskillprepare[4]);
      }else{
        setTimeout(function(){
  ...
  if(p==2){//アイ
    ...
    if(skillusage2[player]>-1){
      ...
      CSkillAnimation(player,0,2,Cskillprepare[3],Cskillprepare[4]);
      }else{
        setTimeout(function(){
          SpecialSkill(player,target)
          }, 550);
    ...
    if(target>=100){ 
      ...
      DP[player]-=10;
      drawDP(player);
      CSkillAnimation(player,SX,2,hand1[SX],-1);
    }else{
      setTimeout(function(){
        SpecialSkill(player,target)
        }, 550);
    ...
    if(skillusage2[player]>-1){
      ...
      DP[player]-=10;
      drawDP(player);
      CSkillAnimation(player,target,2,SX,-1);
    }else{
      setTimeout(function(){
        SpecialSkill(player,target)
        }, 550);
...
cx2.font = "13px Arial";
cx2.fillText("・MPを2ゲージ消費し,", 635, 210);
cx2.fillText("プレイヤーを1人選択して", 635, 230);
cx2.fillText("発動する. そのプレイヤー", 635, 250);
cx2.fillText("の手札をランダムに1枚,", 635, 270);
cx2.fillText("捨てパイと入れ替え,さら", 635, 290);
cx2.fillText("に3巡の間火傷状態にする.", 635, 310);
}else if(p==2){
  var MS=Buff[player].filter(value=>value==2)
  if(!MS.length){MS=[]};
cx2.font = "bold 16px Arial";
  ...
  for(var i=1;i<7;i++){
    ...
    if(A.length>0){
      switch(i){
        ...
        case 5:
          cx2.font = "bold 16px Arial";
          cx2.fillText("火傷"+A.length, 635, y);
          cx2.font = "14px Arial";
          y+=20;
          cx2.fillText(" ポンできない", 635, y);
          y+=20
          y+=20
          break;
        case 6:
...
function saveDL(){//*
  ...
  cx2.font = "18px Arial";
  cx2.clearRect(80,530,670,70)
  cx2.fillText("セーブしました。ロード時はこの画面を開いた状態でページ下部にある", 80, 550);
  cx2.fillText("ファイル選択ボタンをクリックして、ファイルをアップロードしてください。", 80, 570);          
